...
<div class="">
  <div class=" content">
    <div class=" header">
      ...
      <h4 class="title title_add">Cập Nhật Sinh Viên</h4>
       <div class="come-back">
    ...
    <div class=" body">
      ...
      <form name='edit_job' action='<?php echo admin_url();?>Student_Manager/editing_student' method='POST' id="add_form" enctype="multipart/form-data">   
        ...
        <div class="form-group">
          <label for="name"></span>Ma SV</label>
          <!--   <input type="hidden" class="form-control" id="id" name="id" > -->
          <input  type="text" class="form-control" id="add_name" name="code"

          value="<?=$variable->code ?>" placeholder="Enter Country Name">  
      ...
      <?php foreach ($school_year as $key => $value) { ?>
          <option  <?php if ($variable->course == $value->course)  echo "selected"; ?>  value="<?php echo $value->course?> "><?php echo $value->course ?></option>
      <?php } ?>
    </select>
    </div>
