...
<table id="job_table" class="table table-striped table-bordered hover"  cellspacing="0" width="100%">  
  <h3 class="title-page"> Quản Lý Giảng Viên  </h3>
...
<div class="box">
   ...
   <div class = "row">
    <div class="col-md-1 col-md-offset-10">      
      <a style="margin-bottom: 15px;" class= "btn  btn-sm btnAddCountry" href="<?php echo admin_url();?>Teacher_Manager/add_teacher"><i class="fa fa-plus"></i>Thêm</a>
    </div>
  </div>
  <thead>
    <tr>
    ...
    <tr>
      ...
      <td style ="text-align: center;">
        ...
        <div style="display: inline-flex;">
             ...
             <form action ="<?php echo admin_url()?>Teacher_Manager/view_teacher_detail" method ='POST' >
            ...
            <form action ="<?php echo admin_url()?>Teacher_Manager/edit_teacher" method ='POST' >
              <input type="hidden" name="id" value='<?=$values->id?>' >
             ...
             <button class='btn btn-danger delete delete_teacher' row_id='<?=$values->id?>'><i class="fa fa-trash-o"> Xóa</i></button>

           <select class="selectpicker teacher_status" id="sel1" style= "margin-left: 5px;
