...
<div class="">
  <div class=" content">
    <div class=" header">
      ...
      <h4 class="title title_add">Cập Nhật Thê Loại</h4>
       <div class="come-back">
    ...
    <div class=" body">
      ...
      <form name='edit_job' action='<?php echo admin_url();?>dissertation_type/editing_type' method='POST' id="add_form" enctype="multipart/form-data">   
        <span id="error">  </span>
        ...
        <div class="form-group">
          ...
          <!--   <input type="hidden" class="form-control" id="id" name="id" > -->
          <input  type="text" class="form-control" id="add_name" name="description"

          value="<?=$variable->description ?>" placeholder="Enter Country Name">  
