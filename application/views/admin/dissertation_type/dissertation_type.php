...
<table id="job_table" class="table table-striped table-bordered hover"  cellspacing="0" width="100%">  
  <h3 class="title-page"> Quản Lý Thể Loại  </h3>
   ...
   <div class = "row">
    <div class="col-md-1 col-md-offset-10">      
      <a style="margin-bottom: 15px;" class= "btn  btn-sm btnAddCountry" href="<?php echo admin_url();?>dissertation_type/add_type"><i class="fa fa-plus"></i>Thêm</a>
    </div>
  </div>
  <thead>
    <tr>
 ...
 -->
            ...
            <form action ="<?php echo admin_url()?>dissertation_type/edit_type" method ='POST' >
              <input type="hidden" name="id" value='<?=$values->id?>' >
  ...
  <div class="modal-dialog modal-sm">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title" id="myModalLabel">Bạn có muốn xóa thể loại này?</h4>
      </div>
