...
<div class="">
  ...
  <div class=" content">
    ...
    <div class=" header">
      ...
      <h4 class="title title_add">Thêm Thể Loại</h4>
    </div>
    <div class=" body">
...
<form name='add_master_category' action='<?php echo admin_url();?>dissertation_type/do_add_type' id="add_form" method='POST'  enctype="multipart/form-data" >   
  <span id="error">   </span>

  <div class="form-group">
    <label for="name"></span> Tên Thể Loại</label> 

    <input type="text" class="form-control" id="add_title"  name="name"  value="<?php echo set_value('name'); ?>"  placeholder="Nhập tên thể loại">            
    <div class="form-error"> <?php echo form_error('name')?> </div> 
  </div>

   <div class="form-group">
    <label for="name"></span>Mô tả</label> 

    <input type="text" class="form-control" id="add_title"  name="description"   placeholder="Nhập mô tả thể loại">            
    <div class="form-error"> <?php echo form_error('name')?> </div> 
  </div>
